...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .profile img {
        ...
        border-radius: 50%; /* Esto opcionalmente hace que la imagen sea circular */
      }
    </style>
  ...
  <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
    <div class="text-uppercase">Acogedor</div>
                ...
                <span class="text-gradient d-inline" style="background-image: linear-gradient(to right, #5d5dfc, #3498db); color: transparent; -webkit-background-clip: text;">Alimenta tu mente, nutre tu alma</span> 
                </h1>
                <div
   ...
   style="background-color: #5d5dfc; border-radius: 50%; color: white; text-align: center; display: inline-block; line-height: 1.5;">
   Libros</a
                  >
                  <!-- <a
            ...
            <div class="col-xxl-7">
              ...
              <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                <div class="profile" style="background: linear-gradient(to right, #5d5dfc, #3498db);">
                  <!-- TIP: For best results, use a photo with a transparent background like the demo example below-->
                  <!-- Watch a tutorial on how to do this on YouTube (link)-->
                  <img src="https://img.freepik.com/fotos-premium/nino-leyendo-libro-biblioteca_1041769-175.jpg" alt="Imagen">
                  <div class="dots-1">
                    <!-- SVG Dots-->
                    <svg
                      version="1.1"
          ...
          <div class="row gx-5 justify-content-center">
            <div class="col-xxl-8">
              <div class="text-center my-5">
                ...
                <p class="text-muted">
                Aspiramos a ser una librería que inspire y eduque, fomentando el amor por la lectura y la escritura en cada persona que cruza nuestras puertas. Queremos ser un espacio donde se encuentren las mentes más curiosas, donde se despierte la imaginación y se cultiven nuevas ideas. A través de una cuidada selección de libros y actividades culturales, buscamos impulsar el desarrollo intelectual y personal de nuestra comunidad.
                </p>
